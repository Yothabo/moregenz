import { ServiceOption } from '../typesExtended';
import { camerasService } from './cameras';
import { fencingService } from './fencing';
import { accessControlService } from './access-control';
import { alarmsService } from './alarms';
import { networkingService } from './networking';
import { smartHomeService } from './smart-home';
...
export type ServiceKey = keyof typeof serviceFlows;
